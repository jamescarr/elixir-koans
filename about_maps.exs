...
defmodule About_Maps do
  ...
  think "you can ask a map about its keys" do
    ...
    # A: Keys are returned in alphabetical order
  end
  ...
  think "merging together two maps" do
    ...
    assert Map.merge(map_1, map_2) == %{age: 27, likes: "programming", name: "Ryan B."}
  end
  ...
  think "there's more than one way to remove a key" do
    ...
    # The differences here is that delete will remove a single key
    # while Map.drop will delete multiple keys (provided as a list)
  end
